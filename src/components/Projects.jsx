...
const ProjectCard = ({ image, title, description, git, technologies }) => {
    return (
        <div className="max-w-sm sm:max-w-sm md:max-w-sm bg-gray-900 border border-neutral-100 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            {title=='Chat App' && <a href="https://github.com/PavanKalyanSS/ChatApp">
                <img className="w-full rounded-t-lg h-auto object-cover " src={chatapp} alt="" />
            </a>}
            ...
            <div className='m-2 sm:m-4 lg:m-6 flex justify-between'>
                ...
                <a href={"https://github.com/PavanKalyanSS/"} className="text-red-300 border border-gray-200 rounded-lg shadow p-1 sm:p-2 lg:p-3 hover:text-green-500 duration-300">GitHub</a>
            </div>
        </div>
    );
};
            ...
            <div className="flex flex-wrap gap-7 justify-center items-center m-12 p-12">
                {project.map((item, index) => (
                    <ProjectCard
                        ...
                        links={"https://github.com/PavanKalyanSS/"}
                        git={"https://github.com/PavanKalyanSS/"}
...
export const project = [
    {
        title:'Chat App',
        description:'Chat App is a web application I crafted using React, Node JS and React. This project is a modern and engaging social platform that allows users to connect, share content and interact seamlessly.',
        image: {vpn},
        git:'',
